...
export default function MisionesLimpieza() {
  ...
  const datosJuego = {
    "Héroe del Hogar": [
      ...
      {id: 2, mision: "Limpiar el lavaplatos", puntos: 5, tiempo: "10 min", frecuencia: "Diaria", recompensa: "Preparar un café especial", recompensaPersonal: "Espacio libre para personalización", notas: "Usa un desinfectante suave para mantenerlo impecable."},
      ...
      {id: 4, mision: "Vaciar el cesto de basura pequeño", puntos: 5, tiempo: "5 min", frecuencia: "Diaria", recompensa: "Momento de lectura breve", recompensaPersonal: "Espacio libre para personalización", notas: "Combínalo con una tarea más grande para optimizar el tiempo."},
      ...
      {id: 6, mision: "Sacudir cortinas", puntos: 5, tiempo: "10 min", frecuencia: "Mensual", recompensa: "Disfrutar de un aire fresco", recompensaPersonal: "Espacio libre para personalización", notas: "Usa una aspiradora manual para optimizar el proceso."},
      ...
      {id: 9, mision: "Aspirar tapete", puntos: 10, tiempo: "20 min", frecuencia: "Semanal", recompensa: "Descanso para los pies", recompensaPersonal: "Espacio libre para personalización", notas: "Aspira primero y refresca fibras con bicarbonato."},
      ...
      {id: 11, mision: "Doblar ropa", puntos: 10, tiempo: "15 min", frecuencia: "Semanal", recompensa: "Momento de relajación", recompensaPersonal: "Espacio libre para personalización", notas: "Agrupa por categorías para agilizar el proceso."},
      ...
      {id: 13, mision: "Limpiar espejos", puntos: 10, tiempo: "10 min", frecuencia: "Semanal", recompensa: "Estiramiento breve", recompensaPersonal: "Espacio libre para personalización", notas: "Papel periódico funciona bien para evitar rayas."},
      ...
      {id: 17, mision: "Desinfectar control remoto y teclados", puntos: 10, tiempo: "10 min", frecuencia: "Semanal", recompensa: "Momento tecnológico libre", recompensaPersonal: "Espacio libre para personalización", notas: "Usa alcohol isopropílico para eliminar gérmenes y mantener la higiene."},
      ...
      {id: 19, mision: "Lavar y desinfectar almohadas", puntos: 15, tiempo: "30 min", frecuencia: "Mensual", recompensa: "Disfrutar de una cama limpia", recompensaPersonal: "Espacio libre para personalización", notas: "Usa detergente suave para prolongar la vida útil y evitar alergias."}
    ],
    "Maestro/a del Orden": [
      ...
      {id: 39, mision: "Limpiar el filtro de agua", puntos: 10, tiempo: "10 min", frecuencia: "Mensual", recompensa: "Disfrutar de tu bebida favorita", recompensaPersonal: "Mantenerla lista para usar", notas: "Usa vinagre blanco diluido para una limpieza profunda de los conductos."},
    ...
    "Campeón/a de Limpieza Épica": [
      ...
      {id: 54, mision: "Encerar los pisos", puntos: 25, tiempo: "1 hora", frecuencia: "Mensual", recompensa: "Un descanso prolongado", recompensaPersonal: "Tomar un libro inspirador", notas: "Usa productos específicos para pisos de madera para evitar daño."},
